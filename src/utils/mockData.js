...
export const mockCompanies = [
  { id: 1, name: 'Al Rajhi Industries', region: 'middle_east', certifications: ['ISO 9001', 'ISO 14001'], status: 'active', contact: 'ahmed@alrajhi.com', employees: 450 },
  ...
  { id: 3, name: 'Tata Compliance Corp', region: 'india', certifications: ['ISO 9001', 'ISO 45001'], status: 'pending', contact: 'admin@tatacompliance.in', employees: 800 },
  ...
  { id: 6, name: 'Gulf Manufacturing LLC', region: 'middle_east', certifications: ['ISO 14001'], status: 'inactive', contact: 'admin@gulfmfg.ae', employees: 90 },
  ...
  { id: 8, name: 'Bharat Pharma Ltd', region: 'india', certifications: ['ISO 13485'], status: 'pending', contact: 'reg@bharatpharma.co.in', employees: 1200 },
...
export const mockCertificationRequests = [
  { id: 'CR-001', company_id: 1, company: 'Al Rajhi Industries', iso_standard: 'ISO 14001', region: 'middle_east', status: 'pending', assigned_auditor: null, created_at: '2026-03-10', priority: 'high' },
  ...
  { id: 'CR-003', company_id: 3, company: 'Tata Compliance Corp', iso_standard: 'ISO 45001', region: 'india', status: 'approved', assigned_auditor: 'Priya Sharma', created_at: '2026-02-28', priority: 'low' },
  ...
  { id: 'CR-006', company_id: 6, company: 'Gulf Manufacturing LLC', iso_standard: 'ISO 9001', region: 'middle_east', status: 'pending', assigned_auditor: null, created_at: '2026-03-14', priority: 'medium' },
  ...
  { id: 'CR-008', company_id: 8, company: 'Bharat Pharma Ltd', iso_standard: 'ISO 13485', region: 'india', status: 'in_review', assigned_auditor: 'Ravi Kumar', created_at: '2026-03-05', priority: 'high' },
...
export const mockAuditors = [
  { id: 1, name: 'Mohammed Al-Farsi', email: 'mfarsi@certifycx.com', region: 'middle_east', certifications: 3, status: 'active', specialization: 'ISO 9001, ISO 14001' },
  { id: 2, name: 'Lin Wei', email: 'lwei@certifycx.com', region: 'asia', certifications: 5, status: 'active', specialization: 'ISO 27001, ISO 9001' },
  { id: 3, name: 'Priya Sharma', email: 'psharma@certifycx.com', region: 'india', certifications: 4, status: 'active', specialization: 'ISO 45001, ISO 9001' },
  ...
  { id: 6, name: 'Kenji Tanaka', email: 'ktanaka@certifycx.com', region: 'asia', certifications: 3, status: 'active', specialization: 'ISO 22000, ISO 14001' },
  { id: 7, name: 'Ravi Kumar', email: 'rkumar@certifycx.com', region: 'india', certifications: 7, status: 'active', specialization: 'ISO 13485, ISO 9001' },
...
export const mockCertificationBodies = [
  { id: 1, name: 'Bureau Veritas MEA', region: 'middle_east', activeCertifications: 45, status: 'active', accreditation: 'UKAS' },
  { id: 2, name: 'TÜV SÜD Asia Pacific', region: 'asia', activeCertifications: 78, status: 'active', accreditation: 'DAkkS' },
  { id: 3, name: 'BSI India', region: 'india', activeCertifications: 120, status: 'active', accreditation: 'UKAS' },
  { id: 4, name: 'DNV GL Europe', region: 'europe', activeCertifications: 95, status: 'active', accreditation: 'RvA' },
  { id: 5, name: 'SGS North America', region: 'north_america', activeCertifications: 62, status: 'active', accreditation: 'ANAB' },
  { id: 6, name: 'Intertek MEA', region: 'middle_east', activeCertifications: 33, status: 'active', accreditation: 'UKAS' },
];
