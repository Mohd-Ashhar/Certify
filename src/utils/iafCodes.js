// IAF sector codes used when a Certification Body declares the industries it covers.
// Source: IAF MD 17 / ISO/IEC 17021 NACE-aligned sector classification.

export const IAF_SECTOR_CODES = [
  { code: '01', name: 'Agriculture, forestry and fishing' },
  ...
  { code: '29', name: 'Wholesale and retail trade; repair of motor vehicles, motorcycles and personal and household goods' },
